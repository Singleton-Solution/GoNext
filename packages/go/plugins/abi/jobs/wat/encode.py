#!/usr/bin/env python3
"""
Encode the_job.wasm into the Go byte-slice constant the test
binary uses.

Reads `the_job.wasm` from the current directory (where the Makefile
...
WASM = Path("the_job.wasm")

PREAMBLE = '''package jobs
