module github.com/Singleton-Solution/GoNext/apps/api

go 1.25.0

require (
	github.com/99designs/gqlgen v0.17.90
	github.com/Singleton-Solution/GoNext/packages/go v0.0.0-00010101000000-000000000000
...
=======
>>>>>>> 450db53 (test(api/posts): cover PgxStore against testcontainers Postgres)
