/**
 * Tailwind v3 configuration for @gonext/admin.
 *
...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      // Spacing scale mirrors --s-1..--s-10. We intentionally extend
      // (rather than override) so default Tailwind utility classes
      // such as `gap-2`, `p-4` continue to resolve to their built-in
      // values; the brand-specific stops are added as `1..10` aliases.
      spacing: {
        '1': '4px',
        '2': '8px',
        '3': '12px',
