/**
 * Dialog — modal surface on cream paper.
 *
 * Wraps Radix Dialog. The overlay is a low-opacity wash of forest
 * ink (not pure black) so the modal lifts off the cream page without
 * the usual harsh-black overlay tone. The panel uses --r-xl and the
 * sh-lg shadow per the handoff's modal recipe.
 */
'use client';
  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        'rounded-xl border border-border bg-paper-2 p-6 shadow-lg',
        'data-[state=open]:animate-in data-[state=closed]:animate-out',
        'data-[state=open]:fade-in-0 data-[state=closed]:fade-out-0',
